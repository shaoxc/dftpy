...
from dftpy.td.real_time_runner_calculator import RealTimeRunnerCalculator
...
class DFTpyCalculator(object):
    ...
    def get_forces(self, atoms):
        ...
        print(self.results["forces"]["TOTAL"] * FORCE_CONV["Ha/Bohr"]["eV/A"])
...
class TDDFTpyCalculator(object):
    """Time-dependent-DFTpy calculator for ase"""
    ...
    def get_potential_energy(self, atoms=None, **kwargs):
        ...
        energy = self.results["energypotential"]["TOTAL"].energy * ENERGY_CONV["Hartree"]["eV"]
        kedf = KEDF(name="vw")
        energy += kedf(self.results["density"]).energy * ENERGY_CONV["Hartree"]["eV"]
